...
#impute train data
train_data = preprocess_4(train_data, 'data/select_data/analysis_data/norm_parameters.csv', 'model/select/gain')

    


#save data
train_data.to_csv('data/select_data/cache/train_data_2.csv', index = False)
...
train_data.to_csv('data/select_data/cache/train_data_3.csv', index = False)
