...
#  load data
train_data = pd.read_csv('data/select_data/cache/train_data_3.csv')
test_data = pd.read_csv('data/select_data/cache/test_data_1.csv')
...
test_data = preprocess_2(test_data, 'data/select_data/analysis_data/saved_dicts.pkl')
test_data = preprocess_3(test_data, 'data/select_data/analysis_data/cols.txt')
test_data = preprocess_4(test_data, 'data/select_data/analysis_data/norm_parameters.csv','model/select/gain')
...
#  load parameters
parameters = pd.read_csv('data/select_data/analysis_data/norm_parameters.csv')
...
file_path = 'model/select/neuro_network/neuro_network.pt'
...
#  def optimizer
optimizer = optim.Adam(net.parameters(), lr=0.0000001, weight_decay = 1e-4)
            

# start train
train(net, optimizer, criterion, train_loader, test_loader, epochs=10, l1_weight = 58e-3)


#
torch.save(net.state_dict(), 'model/select/neuro_network/neuro_network.pt')
